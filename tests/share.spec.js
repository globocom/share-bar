...
describe('ShareBar - Methods Test Case', function () {
    ...
    describe('destroy', function() {
        ...
        it('should remove class \'share-bar-container\' and \'share-theme\' ', function() {
            ...
            console.info(this.newBar.containers[0].classList.toString());
            this.newBar.destroy();
            console.info(this.newBar.containers[0].classList.toString());
    ...
    describe('createButton', function () {
        ...
        it('should set data-social-network', function () {
            this.newBar.createButton(this.el, 'test', '', 'urltest');
            expect(this.el.querySelector('.share-test a').getAttribute("data-social-network")).toEqual('test');
        });
